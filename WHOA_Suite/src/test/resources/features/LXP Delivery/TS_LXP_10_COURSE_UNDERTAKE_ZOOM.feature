Feature:LXP010: Verify LXP user should be able to enroll for a course with Zoom meeting and complete it
  ...
  Scenario Outline: To verify that Registered LXP User is able to enroll for new course and complete it successfully
    ...
    Examples: 
      ...
      | whoatestautomation@yopmail.com | Demo@123     |ZOOM|
