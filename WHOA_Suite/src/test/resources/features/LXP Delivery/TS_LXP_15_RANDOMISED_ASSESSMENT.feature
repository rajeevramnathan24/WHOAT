Feature:LXP015: Verify LXP user should be able to enroll for a course having Randomised Assessment and complete it
  ...
  @LXPRDMA @LXPregression
  Scenario Outline: To verify that Registered LXP User is able to enroll for Randomised Assessment course and complete it successfully
    ...
    Examples: 
      ...
      | ta02@yopmail.com  | Demo@123     |RDMA18Mar141450|
