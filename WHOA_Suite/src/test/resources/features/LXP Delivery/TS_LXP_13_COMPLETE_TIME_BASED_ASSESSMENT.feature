Feature:LXP013: Verify LXP user should be able to enroll and complete a time based assessment
  ...
  @LXPTOP @LXPregression
  Scenario Outline: To verify that Registered LXP User is able to enroll for new time based assessment course and complete it successfully
    ...
    Examples: 
      ...
      | skiran_cv@yahoo.co.in | abcd1234     |TOP18Mar171054|
