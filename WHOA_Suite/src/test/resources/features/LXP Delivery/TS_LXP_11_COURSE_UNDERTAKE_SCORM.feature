Feature:LXP011: Verify LXP user should be able to enroll for a course with Scorm Package and complete it
  ...
  Scenario Outline: To verify that Registered LXP User is able to enroll for new course and complete it successfully
    ...
    Examples: 
      ...
      | skiran_cv@yahoo.co.in | abcd1234     |ALL03Feb093017|
