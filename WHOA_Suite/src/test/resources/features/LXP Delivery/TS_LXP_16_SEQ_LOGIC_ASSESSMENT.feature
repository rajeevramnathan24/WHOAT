Feature:LXP016: Verify LXP user should be able to enroll for a course having Sequential Logic or dependant sections and complete it
  ...
  @LXPSeq @LXPregression
  Scenario Outline: To verify that Registered LXP User is able to enroll for Sequential Logic or courses with dependant sections and complete it successfully
    ...
    Examples: 
      ...
      #|ta02@yopmail.com  | Demo@123   |SEQL16Mar151031|
      | skiran_cv@yahoo.co.in | abcd1234     |SEQL16Mar130100|
      #| whoatestautomation@yopmail.com  | Demo@123         |SEQL16Mar151031|
