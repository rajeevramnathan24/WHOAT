Feature:LXP007: Verify LXP user should be able to enroll for a course with html text and complete it
  ...
  Scenario Outline: To verify that Registered LXP User is able to enroll for new course and complete it successfully
    ...
    Examples: 
      ...
      | ta02@yopmail.com | Demo@123     |ALL07Dec182032|
