Feature:CS015: Verify new Course creation in Studio for Scorm V2 Package component
  
Given As an Admin user
  When logged in to course Studio
  And while creating a new course and configuring it 
  Then user should be able to add new Scorm V2 package component

  @CourseCreation @Studioregression @ScormV2
  Scenario Outline: To verify that Registered User is able to create new courses in Course Studio
    ...
    Examples: 
     ...
     |1 | whoatestautomation@yopmail.com  | Demo@123         | SCOV2       | ScormV2 |
