Feature:CS009: Verify Digital Credentials can be activated for a course

Given As an Admin user
  When logged in to course Studio
  And while creating a new course and configuring it 
  Then user should be able to enable and activate Digital Credentials for the course

  @DigitalCredentials @Studioregression 
  Scenario Outline: To verify that Registered User is able to create new courses in Course Studio
    ...
    Examples: 
     ...
     |1 | whoatestautomation@yopmail.com  | Demo@123         | DGC       | HTML-Text |
