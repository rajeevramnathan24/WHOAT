Feature:CS019: Verify new Courses can be created with Time based Assessments
  
	Given As an Admin user
  When logged in to course Studio
  Then user should be able to create new courses with Time Based Assessments
    
  @TOP @Studioregression
  Scenario Outline: To verify that Registered User is able to create new courses with Time Based Assessments
    ...
    Examples: 
     ...
     |1 | whoatestautomation@yopmail.com  | Demo@123         | TOP       | Problem-Dropdown |
     |2 | whoatestautomation@yopmail.com  | Demo@123         | INTBA       | Problem-Dropdown |
