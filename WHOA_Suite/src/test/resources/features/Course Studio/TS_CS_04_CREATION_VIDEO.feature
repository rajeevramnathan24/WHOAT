Feature:CS004: Verify new Course creation in Studio for Video component
  
Given As an Admin user
  When logged in to course Studio
  And while creating a new course and configuring it 
  Then user should be able to add new component like Video component

  @CourseCreation @Studioregression @Video
  Scenario Outline: To verify that Registered User is able to create new courses in Course Studio
    ...
    Examples: 
     ...
     |1 | whoatestautomation@yopmail.com  | Demo@123         | VID       | Video |
