Feature:CS007: Verify new Course creation in Studio for all components
  
  Given As an Admin user
  When logged in to course Studio
  And while creating a new course and configuring it 
  Then user should be able to add new component like HTML Text, Problem - dropdown, Video, Zoom integration, Discussion forum
 
  @CourseCreation @Studioregression @CourseCreationAll 
  Scenario Outline: To verify that Registered User is able to create new courses in Course Studio
    ...
    Examples: 
     ...
     |1 | whoatestautomation@yopmail.com  | Demo@123         | ALL       | HTML-Text, Problem-Dropdown, Video, Zoom-Int, Discussion |
