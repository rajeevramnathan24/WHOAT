Feature:CS008: Verify Course creation in local language
     
  Given As an Admin user
  When logged in to course Studio 
  Then a new course can be created in different local Language

  @SpecificLanguageCourse @Studioregression 
  Scenario Outline: To verify that Registered User is able to create new courses in Course Studio
    ...
    And user updates course start and end date time, enrollment start and end date time on Schedule & Details in specific "<Language>"
    #*******Course Outline page
    ...
    Examples: 
     |id | Studio User Name | Studio Password | Course Name | Component-Type | Language |
     |1 | whoatestautomation@yopmail.com  | Demo@123         | ARAC       | HTML-Text | Arabic|
     |2 | whoatestautomation@yopmail.com  | Demo@123         | FRNC       | HTML-Text | French|
     |1 | whoatestautomation@yopmail.com  | Demo@123         | ESPC       | HTML-Text | Spanish|
     |4 | whoatestautomation@yopmail.com  | Demo@123         | RUSC       | HTML-Text | Russian|
     |5 | whoatestautomation@yopmail.com  | Demo@123         | ZHUC       | HTML-Text | Chinese|
